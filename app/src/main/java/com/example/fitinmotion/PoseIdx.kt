...
object PoseIdx {
    const val NOSE = 0
    const val LEFT_EYE_INNER = 1; const val LEFT_EYE = 2; const val LEFT_EYE_OUTER = 3
    const val RIGHT_EYE_INNER = 4; const val RIGHT_EYE = 5; const val RIGHT_EYE_OUTER = 6
    const val LEFT_EAR = 7; const val RIGHT_EAR = 8
    const val LEFT_MOUTH = 9; const val RIGHT_MOUTH = 10
    ...
    const val LEFT_PINKY = 17; const val RIGHT_PINKY = 18
    const val LEFT_INDEX = 19; const val RIGHT_INDEX = 20
    const val LEFT_THUMB = 21; const val RIGHT_THUMB = 22
